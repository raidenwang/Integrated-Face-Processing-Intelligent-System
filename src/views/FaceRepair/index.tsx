...
const FaceRepair = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:6006/face-repair', formData, {
        headers: {
    ...
    >
      ...
      >
        ...
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          ...
          {resultImageUrl && (
            <div>
              <Paragraph strong>修复结果：</Paragraph>
              <Image
                src={resultImageUrl}
                alt="修复结果图像"
                style={{ maxWidth: '100%', height: 'auto', border: '1px solid #ccc', borderRadius: '8px' }}
